...
exports.cleanDevspaceConfig = exports.cmdDevSpaceConnectNewWindow = exports.closeTunnels = void 0;
const vscode_1 = require("vscode");
const node_url_1 = require("node:url");
const ssh_utils_1 = require("./tunnel/ssh-utils");
const logger_1 = require("./logger/logger");
const messages_1 = require("./messages");
const ssh_1 = require("./tunnel/ssh");
...
function closeTunnels() {
    (0, ssh_1.closeSessions)();
}
exports.closeTunnels = closeTunnels;
async function createTunnel(devSpace, config, progress) {
    ...
    return (0, ssh_utils_1.runChannelClient)({
