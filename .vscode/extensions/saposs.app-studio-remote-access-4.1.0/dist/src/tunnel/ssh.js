...
exports.internal = exports.ssh = exports.closeSessions = void 0;
...
function closeSessions(sessions) {
    Array.from(sessionMap.entries()).forEach(([key, session]) => {
        ...
        void session.close(dev_tunnels_ssh_1.SshDisconnectReason.byApplication);
        sessionMap.delete(key);
    });
}
exports.closeSessions = closeSessions;
...
async function ssh(opts) {
    ...
    try {
        ...
        await pfs.forwardToRemotePort("127.0.0.1", parseInt(opts.client.port, 10), "127.0.0.1", 2222);
