...
describe("basctlServer", () => {
    ...
    it(`startBasctlServer socket exists, 
        ...
        mockIpc();
        (0, basctlServer_1.startBasctlServer)(context);
    });
    it(`startBasctlServer socket exists, 
        unlink successfull, 
        listen successful, 
    ...
    it(`startBasctlServer socket exists, 
        ...
        (0, chai_1.expect)(() => (0, basctlServer_1.startBasctlServer)(context)).to.throw(/Failed to unlink socket \/extbin\/basctl/);
    });
    ...
    function mockIpc(options) {
        envVarCollectionMock
            .expects("replace")
            .withExactArgs("BASCTL_SOCKET", sinon_1.match.string.and((0, sinon_1.match)(/^\/extbin\/basctl.?/)));
        ...
        if (options && options.socketInUse) {
            serverMock
                ...
                .calledWithMatch(sinon_1.match.string.and((0, sinon_1.match)(/^\/extbin\/basctl.?/)));
            windowMock
