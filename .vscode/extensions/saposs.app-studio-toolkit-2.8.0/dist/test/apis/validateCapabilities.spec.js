...
(0, mockUtil_1.mockVscode)(testVscode, "dist/src/apis/validateHanacalcviewCapabilities.js");
...
const validateHanacalcviewCapabilities_1 = require("../../src/apis/validateHanacalcviewCapabilities");
    ...
    describe("validate returned value according to the extension existence", () => {
        ...
        it("should return false when LCAP extension does not exist", async () => {
            extensionsMock
                ...
                .withExactArgs(validateLCAP_1.LCAP_EXTENSION_ID)
                .returns(undefined);
            const parameterValue = await (0, validateLCAP_1.isLCAPEnabled)();
            (0, chai_1.expect)(parameterValue).to.be.false;
        });
        it("should return true when LCAP extension exists", async () => {
            const extension = { id: validateLCAP_1.LCAP_EXTENSION_ID };
            extensionsMock
                .expects("getExtension")
                .withExactArgs(validateLCAP_1.LCAP_EXTENSION_ID)
                .returns(extension);
        ...
        it("should return false when Hana calculation view extension does not exist", async () => {
            extensionsMock
                .expects("getExtension")
                .withExactArgs(validateHanacalcviewCapabilities_1.HANA_CALC_VIEW_EXTENSION_ID)
                .returns(undefined);
            const parameterValue = await (0, validateHanacalcviewCapabilities_1.hasHanacalcviewCapabilities)();
            (0, chai_1.expect)(parameterValue).to.be.false;
        });
        it("should return true when Hana calculation view extension exists", async () => {
            const extension = { id: validateHanacalcviewCapabilities_1.HANA_CALC_VIEW_EXTENSION_ID };
            extensionsMock
                .expects("getExtension")
                .withExactArgs(validateHanacalcviewCapabilities_1.HANA_CALC_VIEW_EXTENSION_ID)
                .returns(extension);
