...
const vscodeProxy = {
    workspace: {
        getConfiguration: () => {
            return {
                get: (0, sinon_1.stub)().returns(undefined),
                update: (0, sinon_1.stub)().resolves(),
            };
        },
    ...
    EventEmitter: class EventEmitterMock {
        constructor() {
            this.fire = (0, sinon_1.stub)().returns(void 0);
        }
    },
};
...
(0, mockUtil_1.mockVscode)(vscodeProxy, "dist/src/devspace-manager/landscape/landscape.js");
...
describe("extension unit test", () => {
    ...
    describe("initBasRemoteExplorer", () => {
        ...
        it("command `app-studio-toolkit.devspace-manager.landscape.default-off`", async () => {
            ...
            await registry.get(`app-studio-toolkit.devspace-manager.landscape.default-off`)()).be.undefined;
        });
        it("command `app-studio-toolkit.devspace-manager.get-default-landscape`", () => {
            instance.initBasRemoteExplorer(context);
            (0, chai_1.expect)(registry.get(`app-studio-toolkit.devspace-manager.get-default-landscape`)()).be.empty;
        });
        it("command `local-extension.tree.refresh`", () => {
            instance.initBasRemoteExplorer(context);
            (0, chai_1.expect)(registry.get(`local-extension.tree.refresh`)()).be.undefined;
        });
        ...
        it("authentication.onDidChangeSessions registered", () => {
            ...
            instance.initBasRemoteExplorer(context);
            (0, chai_1.expect)(onDidChangeSessionsStub.calledOnce).to.be.true;
        });
        it("authentication.onDidChangeSessions callback", async () => {
            ...
            (0, chai_1.expect)(callback).to.be.a("function");
            // Simulate session change
            authenticationMock
                .expects(`getSession`)
                .withExactArgs(authProvider_1.BasRemoteAuthenticationProvider.id, [], { silent: true })
                .resolves();
            const sessionChangeEvent = {
                provider: { id: authProvider_1.BasRemoteAuthenticationProvider.id },
            };
            commandsMock
                .expects(`executeCommand`)
