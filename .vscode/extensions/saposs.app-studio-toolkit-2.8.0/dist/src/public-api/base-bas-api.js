...
const validateHanacalcviewCapabilities_1 = require("../apis/validateHanacalcviewCapabilities");
const isOpenedForAction_1 = require("../apis/isOpenedForAction");
const basClientFactory_1 = require("../telemetry/basClientFactory");
/**
...
exports.baseBasToolkitAPI = {
    ...
    hasHanacalcviewCapabilities: validateHanacalcviewCapabilities_1.hasHanacalcviewCapabilities,
    isOpenedForAction: isOpenedForAction_1.isOpenedForAction,
    getTelemetryReporter: (extensionId, extensionVersion) => basClientFactory_1.BASClientFactory.getBASTelemetryClient(extensionId, extensionVersion),
    actions: {
        performAction: client_1.performAction,
