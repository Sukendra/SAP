...
exports.hasJwt = exports.getJwt = exports.retrieveJwt = exports.JWT_TIMEOUT = void 0;
    ...
    return new Promise((resolve, reject) => {
        ...
        app.post("/ext-login", function (request, response) {
            ...
            if (!jwt || jwt.startsWith("<html>")) {
                ...
                resolve({ jwt, iasjwt: (_b = request.body.iasjwt) !== null && _b !== void 0 ? _b : "" });
            }
        });
    ...
    return new Promise((resolve, reject) => {
        ...
        function handleEvent(event) {
            ...
            if ((_a = event.jwt) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase().startsWith("<html>")) {
                ...
                resolve({ jwt: (_b = event.jwt) !== null && _b !== void 0 ? _b : "", iasjwt: (_c = event.iasjwt) !== null && _c !== void 0 ? _c : "" });
            }
...
async function getJwtFromServerWithTimeout(ms, promise) {
    return Promise.race([
        promise,
        new Promise((_, reject) => setTimeout(() => reject(new Error(messages_1.messages.err_get_jwt_timeout(ms))), ms)),
    ]);
}
...
async function getJwt(landscapeUrl, isIasjwt = false) {
    var _a;
    ...
    const iasToken = (_a = session) === null || _a === void 0 ? void 0 : _a.iasToken;
    if (accessToken) {
    ...
    const msg = messages_1.messages.err_get_jwt_not_exists;
    (0, logger_1.getLogger)().debug(msg);
    throw new Error(msg);
}
exports.getJwt = getJwt;
async function hasJwt(landscapeUrl, isIasjwt = false) {
    try {
        const jwt = await getJwt(landscapeUrl, isIasjwt);
        return !bas_sdk_1.core.isJwtExpired(jwt);
    }
    catch (_a) {
        return false;
    }
