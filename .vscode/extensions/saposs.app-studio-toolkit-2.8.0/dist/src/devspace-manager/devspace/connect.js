...
exports.cmdDevSpaceOpenInBAS = exports.cmdDevSpaceConnectNewWindow = exports.closeTunnels = void 0;
const vscode_1 = require("vscode");
const url_join_1 = __importDefault(require("url-join"));
const logger_1 = require("../../../src/logger/logger");
const messages_1 = require("../common/messages");
async function closeTunnels() {
    await vscode_1.commands.executeCommand("remote-access.close-tunnel");
}
